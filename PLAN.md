...
| P5-5 | release-engineer 升 v0.2.0 + RELEASE_NOTES + CI 验证 | `READY_FOR_RELEASE` | release-engineer | **P5-5 IMPL_DONE**（待 commit 用户拍板）：version 三处同步 0.1.0→0.2.0（package.json/tauri.conf.json/Cargo.toml）+ RELEASE_NOTES_v0.2.0.md 127 行 + CI build.yml gate+matrix+artifact 已就绪。**用户执行清单**：git tag v0.2.0 + push --tags + GitHub Release 上传 |
